...
filenames = ["a_1120_1_10_2e7_y_1_0.01", "a_800_1_10_2e7_y_0.5_0.01", "a_560_1_10_2e7_y_1_0.01", "a_800_1_10_2e7_y_1_0.01", "a_800_1_10_2e7_y_1_0.1", "a_800_1_10_1e5_y_1_0.01", "a_800_1_10_2e7_y_1_1", "a_800_1_10_2e6_y_1_0.01", "a_800_1_10_2e7_y_2_0.01", "a_800_2_10_2e7_y_1_0.01",]    
...
def DataDump(sim):
    ...
    for i in range(751):
        ...
        if (i>=100): ext=str(i)
        current_snap = sorted(glob(sims_dir+sim+"/output/snapshot*.hdf5"))[i] # get the last snapshot
        print("snap_" + str(i))
